angular
    ...
    .factory('monitorLogService', monitorLogService)
    ...
    .factory('dashboardReportService', dashboardReportService)
    .factory('corperateService', corperateService)
    .factory('defaultCoverImageService',defaultCoverImageService)
...
function authService($q, $http, $window, appSetting, $http, $cookies, storageService) {
    ...
    service.isGranted = function (permissionName) {
        ...
        } else if (permissionName == "view_dashboard_report") {
            // alert(JSON.stringify(myPermission));
            console.log(permissionName);
            return true;
            // return myPermission.dashboard_report == 'Y' ? true : false;
        } else if (permissionName == "edit_dashboard_report") {
            // alert(JSON.stringify(myPermission));
            console.log(permissionName);
            return true;
            //
        ...
        return myPermission[permissionName] == 'Y' ? true : false;
        return granted;
    }
...
function newsService($q, $http, appSetting) {
    ...
    service.updateNewsStatus = function (data) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/news/updateStatusNews',
...
batchService.$inject = ['$q', '$http', 'appSetting'];
function batchService($q, $http, appSetting) {
    var service = {};

    service.searchBatch = function () {
        var deferred = $q.defer();
        $http({
            method: 'GET',
            url: appSetting.apiBaseUrl + '/api/batch/getBatchList'
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
            deferred.reject(response);
    ...
    service.runBatch = function (batch_path) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/batch/runBatch',
            data: {
                batch_path
            }
        }).then(function successCallback(response) {
...
dashboardReportService.$inject = ['$q', '$http', 'appSetting'];
function dashboardReportService($q, $http, appSetting) {
    var service = {};

    service.getDashboardReportCriteria = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'GET',
            url: appSetting.apiBaseUrl + '/api/category/getCategories/Dashboard'
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
            deferred.reject(response);
    ...
    service.searchReportConfig = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',

            url: appSetting.apiBaseUrl + '/api/report/SearchReportConfigs',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.updateStatus = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',

            url: appSetting.apiBaseUrl + '/api/report/updateStatusReportConfig',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.deleteReport = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',

            url: appSetting.apiBaseUrl + '/api/report/deleteReportConfigs',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.updateReportPriority = function (obj) {
        var deferred = $q.defer();
        // var {report_ID,priority,category_ID}=obj;
        // alert(11);
        // console.log({report_ID,priority,category_ID})
        // console.log(data);
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/report/updateReportConfigPriority',
            data: { report_ID: obj.report_ID, priority: obj.priority, category_ID: obj.category_ID }
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
            deferred.reject(response);
...
monitorLogService.$inject = ['$q', '$http', 'appSetting'];
function monitorLogService($q, $http, appSetting) {
    var service = {};

    service.SearchReportQueues = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/report/SearchReportQueues',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.SearchEmailQueues = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',

            url: appSetting.apiBaseUrl + '/api/report/SearchEmailQueues',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.deleteReportQueues = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',

            url: appSetting.apiBaseUrl + '/api/report/deleteReportQueues',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.deleteEmailQueues = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/report/deleteEmailQueues',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.reSyncReportTableau = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/report/reSyncReportTableau',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.reSyncEmailQueue = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/report/reSyncEmailQueue',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.getReportQueueByDue = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/report/getReportQueueByDue',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
...
function downloadService($q, $http, appSetting) {
    ...
    service.getSubCategories = function (id) {
        ...
        $http({
            method: 'GET',
            url: appSetting.apiBaseUrl + '/api/category/getSubCategories/' + id,
            data: {
            }
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
    ...
    service.searchDocuments = function (obj) {
        ...
        if (obj.SubCategoryID != '') {
            data.SubCategoryID = obj.SubCategoryID;
        }
        $http({
            method: 'POST',
    ...
    // service.updateDocumentPriority = function (data) {
    //     var deferred = $q.defer();
    //     $http({
    //         method: 'POST',
    //         url: appSetting.apiBaseUrl + '/api/download/updateDocumentPriority',
    ...
    service.updateStatus = function (data) {
        ...
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/download/updateStatusDocument',
            data: data
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
...
function applicationService($q, $http, appSetting) {
    ...
    service.updateStatus = function (data) {
        ...
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/application/updateStatusApplications',
            data: data
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
...
defaultCoverImageService.$inject = ['$q', '$http', 'appSetting'];
function defaultCoverImageService($q, $http, appSetting) {
    var service = {};
    ...
    service.searchDefaultCoverImage = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/coverImage/searchCoverImage',
            data: {
                pageSize: obj.pageSize,
                pageNumber: obj.pageNumber,
                sortingOrder: obj.sortingOrder,
    ...
    service.updateStatus = function (data) {
        ...
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/policy/updateStatusPolicy',
            data: data
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
...
function faqsService($q, $http, appSetting) {
    ...
    service.updateStatus = function (data) {
        ...
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/faqs/updateStatusFAQs',
            data: data
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
...
corperateService.$inject = ['$q', '$http', 'appSetting'];
function corperateService($q, $http, appSetting) {
    var service = {};

    service.searchCorperate = function (obj) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/corperate/searchCorperate',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.deleteCorperate = function (ids) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/corperate/deleteCorperates',
            data: {
                CorperateIds: ids
            }
        }).then(function successCallback(response) {
...
function userService($q, $http, appSetting) {
    ...
    service.updateStatus = function (obj) {
        ...
        $http({
            method: 'POST',
            url: appSetting.apiBaseUrl + '/api/permission/updateStatusPermission',
            data: obj
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
    ...
    service.anyWebServiceCorperateUser = function (userId) {
        var deferred = $q.defer();
        $http({
            method: 'GET',
            url: appSetting.apiBaseUrl + '/api/permission/anyWebServiceCorperateUser/' + userId
        }).then(function successCallback(response) {
            deferred.resolve(response.data);
        }, function errorCallback(response) {
            deferred.reject(response);
