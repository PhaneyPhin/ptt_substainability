...
function config($stateProvider, $urlRouterProvider, $httpProvider, $locationProvider, toastrConfig) {
	...
	$stateProvider
		...
		.state('batch-process', {
			url: '/batch-process',
			templateUrl: 'views/batch-job.html'
		})
		// Main user portal
		.state('portal', {
			abstract: true,
		...
		.state('portal.editDashboardReport',{
			url: "/dashboard-reaport-edit",
			params: { obj: null },
			templateUrl: 'views/dashboard-report/edit.html'
		})
		...
		.state('portal.monitorTableau', {
			url: "/monitor-tableau",
			templateUrl: 'views/monitor-log/monitor-tableau.html'
		})
		.state('portal.monitorEmail',{
			url:"/monitor-email",
			templateUrl:'views/monitor-log/monitor-email.html'
		})
		.state('portal.tablueDetail',{
			url:'/tableau-monitor-detail',
			params: { obj: null },
			templateUrl:'views/monitor-log/tableau-detail.html'
		})
		.state('portal.corperateList',{
			url:'/corperate-list',
			params: { obj: null },
			templateUrl:'views/corperate/list.html'
		})
		.state('portal.addCorperate',{
			url:'/add-corperate',
			params: { obj: null },
			templateUrl:'views/corperate/add.html'
		})
		.state('portal.editcorperate',{
			url:'/edit-corperate',
			params: { obj: null },
			templateUrl:'views/corperate/edit.html'
		})
		.state('portal.googleAnalytics',{
			url:'/google-analytics',
			params: {obj: null},
			templateUrl: 'views/google-analytics.html'
		})
		.state('portal.coverImage',{
			url:"/default-cover-image",
			params:{obj:null},
			templateUrl:'views/defualt-cover-image/list.html'
		})
		.state('portal.editCoverImage',{
			url:"/default-cover-image",
			params:{obj:null},
			templateUrl:'views/defualt-cover-image/edit.html'
		})
