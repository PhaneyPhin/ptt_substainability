...
export class PolicyTargetService extends BaseService {

  getPolicy(data): Observable<any> {
    return this.http.post<any>(this.url + '/policy/getPolicyByCagetory', data, this.httpOptions)
